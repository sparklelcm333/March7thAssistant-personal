...
DEFAULT_CARDS = [
    ...
    },
    {
        ...
        "menu_items": [
            ...
            {"label": tr("模拟宇宙快速启动"), "task_id": "universe"},
            {"label": tr("模拟宇宙原版运行"), "task_id": "universe_gui"},
            {"label": tr("重置模拟宇宙配置文件"), "task_id": "_reset_universe_config"},
            {"label": tr("打开模拟宇宙目录"), "task_id": "_open_universe_dir"},
            {"label": tr("打开模拟宇宙项目主页"), "task_id": "_open_universe_homepage"},
        ]
    },
    {
