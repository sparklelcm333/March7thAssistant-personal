...
"""
        ...
        self.githubCard = PrimaryPushSettingCard(
            ...
            FIF.GITHUB,
            tr('项目主页'),
            "https://github.com/sparklelcm333/March7thAssistant-personal"
        )
    ...
    def __connectSignalToSlot(self):
        ...
        self.githubCard.clicked.connect(self.__openUrl("https://github.com/sparklelcm333/March7thAssistant-personal"))
