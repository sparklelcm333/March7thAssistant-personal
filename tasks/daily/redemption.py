...
def valid_codes_for_server(server: str, now: Optional[datetime.datetime] = None) -> List[str]:
    ...
    url = [
        ...
        "https://cdn.jsdelivr.net/gh/sparklelcm333/March7thAssistant-personal@main/assets/config/redemption_codes.json",
        "https://raw.githubusercontent.com/sparklelcm333/March7thAssistant-personal/refs/heads/main/assets/config/redemption_codes.json"
    ]
