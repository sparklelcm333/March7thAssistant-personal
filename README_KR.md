...
- 개인 맞춤 버전으로 안정성이 보장되지 않습니다. 원본(업스트림) 버전을 원하시면 [moesnow/March7thAssistant](https://github.com/moesnow/March7thAssistant)를 이용해 주세요

## 다운로드 및 설치

[Releases](https://github.com/sparklelcm333/March7thAssistant-personal/releases/latest)에서 최신 버전을 내려받아 압축을 푼 뒤, 3월 7일 아이콘이 있는 `March7thAssistant.exe`를 더블 클릭해 GUI를 실행하세요.
